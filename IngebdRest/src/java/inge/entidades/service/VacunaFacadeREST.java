 ...
 */
@javax.ejb.Stateless
@Path("inge.entidades.vacuna")
public class VacunaFacadeREST extends AbstractFacade<Vacuna> {

    @PersistenceContext(unitName = "IngebdRestPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Vacuna entity) {
        super.edit(entity);
    }
    ...
    public Vacuna find(@PathParam("id") String id) {
